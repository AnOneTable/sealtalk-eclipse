        ...
        dialog.setConfirmListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if (Build.VERSION.SDK_INT >= 23) {
                    int checkPermission = ContextCompat.checkSelfPermission(MyAccountActivity.this, Manifest.permission.CAMERA);
                        ...
                        if (ActivityCompat.shouldShowRequestPermissionRationale(MyAccountActivity.this, Manifest.permission.CAMERA)) {
                            ...
                            .setPositiveButton("确认", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                	ActivityCompat.requestPermissions(MyAccountActivity.this, new String[] {Manifest.permission.CAMERA}, REQUEST_CODE_ASK_PERMISSIONS);
                                }
                            })
